...
const WingtipPinWhite = () => {
  const [Title, SetTitle] = useState("T-Shirt Kids Nk Logo Pin Black -");
  ...
  const settings = {
    ...
    customPaging: function (i) {
      return (
        ...
        >
          <img
            src={require(`../../plugin/img/ccloth/cloth-3-${i + 1}.png`)}
  ...
  return (
    <div className={`${isModalOpen ? "" : ""}`}>
      ...
      <div className="grid grid-cols-2 gap-3 w-[80%] mx-auto mt-28 z-50">
        ...
        <div>
          ...
          <div className="w-[350px] mt-20">
            ...
            <hr />
            <p className="py-2">SKU: S123 KIDS NKLOGOPIN WHITE</p>
            <hr />
            <p>
      ...
      <Modal3 isOpen={isModalOpen} onClose={handleCloseModal} />
    </div>
  );
};
