...
const WingtipFontBlack = () => {
  const [Title, SetTitle] = useState("T-Shirt Kids NK13 Font Black -");
  ...
  const settings = {
    ...
    customPaging: function (i) {
      return (
        ...
        >
          <img
            src={require(`../../plugin/img/ccloth/cloth-6-${i + 1}.png`)}
  ...
  return (
    <div className={`${isModalOpen ? "" : ""}`}>
      ...
      <div className="grid grid-cols-2 gap-3 w-[80%] mx-auto mt-28 z-50">
        ...
        <div>
          ...
          >
            ...
            <button className="uppercase bg-[#cecece] hover:bg-[rgb(185,185,185)] text-lg px-4 font-bold text-white">
              add to cart
            </button>
          </div>
          <div className="w-[350px] mt-20">
            ...
            <hr />
            <p className="py-2">SKU: S123 KIDS NK13FONT BLACK</p>
            <hr />
            <p>
      ...
      <Modal6 isOpen={isModalOpen} onClose={handleCloseModal} />
    </div>
  );
};
